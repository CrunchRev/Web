...
internal_logger.info("Initialized bcrypt (1 / 13).")

Signer = Signer(settings["PK1024Path"], settings["PK2048Path"])
internal_logger.info("Initialized script signer (2 / 13).")
Filter = TextFilter()
internal_logger.info("Initialized text filter (3 / 13).")
Tickets = Tickets(settings["PK1024Path"], settings["PK2048Path"])
internal_logger.info("Initialized tickets generator (4 / 13).")
UserDB = UserDB(Database, bcrypt)
internal_logger.info("Initialized users database (5 / 13).")
GamesDB = GamesDB(Database, settings["URL"])
internal_logger.info("Initialized games database (6 / 13).")
ArbiterClass = Arbiter(settings["arbiterURLs"], Database, GamesDB)
internal_logger.info("Initialized arbiter (class) (7 / 13).")
Assets = Assets(Database)
internal_logger.info("Initialized assets (class) (8 / 13).")
Token = Token()
internal_logger.info("Initialized safety token system (9 / 13).")
DataStore = DataStore(Database)
internal_logger.info("Initialized datastore (class) (10 / 13).")
Webhooks = Webhooks()
internal_logger.info("Initialized webhooks (class) (11 / 13).")
PointsService = PointsService(Database)
internal_logger.info("Initialized points service (class) (12 / 13).")
SysStorage = SysStorage(Database)
internal_logger.info("Initialized system storage (class) (13 / 13).")
